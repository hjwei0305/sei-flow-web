/**
 * @description 替换固化执行人弹窗
 * @author 何灿坤
 */

import React, {Component} from 'react'
import TransferTable from "@/components/TransferTable";
import {listAllOrgs, listAllUserByOrgId} from './ReplaceSolidifyExecutorService';
import {seiLocale} from 'sei-utils';

const {seiIntl} = seiLocale;

class ReplaceSolidifyExecutorSelected extends Component {
  constructor(props) {
    super(props);
    this.state = {
      leftData: null,
...
export default ReplaceSolidifyExecutorSelected
