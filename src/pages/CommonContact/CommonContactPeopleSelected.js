/**
 * @description 常用联系人选择弹窗
 * @author 何灿坤
 */

import React, {Component} from 'react'
import TransferTable from "@/components/TransferTable";
import {listAllOrgs, listAllUserByOrgId} from './CommonContactService';
import {seiLocale} from 'sei-utils';

const {seiIntl} = seiLocale;

class CommonContactPeopleSelected extends Component {
  constructor(props) {
    super(props);
    this.state = {
      leftData: null,
...
export default CommonContactPeopleSelected
