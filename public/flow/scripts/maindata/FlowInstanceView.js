...
EUI.FlowInstanceView = EUI.extend(EUI.CustomUI, {
    ...
    addEvents: function () {
        ...
        $(".ecmp-common-view").live("click", function () {
            ...
            var webBaseAddressNoBias = "";
            if(data.webBaseAddress!=null){
                webBaseAddressNoBias = data.webBaseAddress.replace("/","");
            }
            var tab = {
                title: g.lang.viewOrderText,
                url: _basePath +"/"+ webBaseAddressNoBias +"/"+ lookUrl + "?id=" + data.businessId,
                id: data.businessId
            };
            g.addTab(tab);
        });
