...
if (EUI.AddSignView) {
  EUI.apply(EUI.AddSignView.prototype.lang, {
    searchBoxText: "请输入名称进行查询",
    addText: "加签",
    nodeKeyText: "流程节点key",
    nodeNameText: "流程节点名称",
    businessCodeText: "业务单据编码",
    businessNameText: "业务单据名称",
    businessModelRemarkText: "业务摘要",
    flowNameText: "流程名称",
    flowDefKeyText: "流程定义key",
    codeText: "员工编号",
    nameText: "用户名称",
    organizationNameText: "组织机构",
    searchText: "根据名称搜索",
    addMessageText: "你确定要加签吗？",
    addMaskMessageText: "正在进行加签，请稍等...",
    searchAndCodeText: "根据名称或编号搜索"
  }, common_lang);
}
;
if (EUI.SubtractSignView) {
  EUI.apply(EUI.SubtractSignView.prototype.lang, {
    searchBoxText: "请输入名称进行查询",
    codeText: "员工编号",
    nameText: "用户名称",
    organizationNameText: "组织机构",
    ...
    flowNameText: "流程名称",
    flowDefKeyText: "流程定义key",
    subtractMessageText: "你确定要减签吗？",
    subtractMaskMessageText: "正在进行减签，请稍等..."
  }, common_lang);
}
;
...
if (EUI.FlowDefinationView) {
  EUI.apply(EUI.FlowDefinationView.prototype.lang, {
    addResourceText: "新增",
    copyText: "参考创建",
    resetPositionText: "位置重置",
    resetPositionHintMessageText: "您确定要重置流程图位置吗？",
    resetPositionMaskMessageText: "正在重置流程图位置，请稍候...",
...
if (EUI.TurnToDoView) {
  EUI.apply(EUI.TurnToDoView.prototype.lang, {
    modelText: "应用模块",
    businessEntityText: "业务实体",
    flowTypeText: "流程类型",
    searchByNameText: "请输入名称搜索",
...
if (EUI.ChooseUserView) {
  EUI.ChooseUserView.prototype.lang = EUI.applyIf({
    queryMaskMessageText: "正在加载，请稍候...",
    cancelText: "取消",
    okText: "确定",
    submitText: "提交",
